 ...
 * @date 2021-03-23
 */
@ApiRechargeHandlerProperty(ApiRechargeConfigCodeEnum.TEST_2)
@ApiWithdrawHandlerProperty(ApiWithdrawConfigCodeEnum.TEST_2)
public class TestPay2 implements ApiRechargeHandler, ApiWithdrawHandler {
    ...
    public ApiRechargeRequestResponseVO requestRecharge(ApiRechargeConfig config,
        ...
        // test
        RechargeRequestResponseVO rsp = RechargeRequestResponseVO.url(order.getId(), "https://www.baidu.com");
