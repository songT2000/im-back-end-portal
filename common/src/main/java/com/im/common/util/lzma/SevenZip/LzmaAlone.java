package com.im.common.util.lzma.SevenZip;
...
public class LzmaAlone
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (params.Command == CommandLine.kBenchmak)
		{
			...
			com.im.common.util.lzma.SevenZip.LzmaBench.LzmaBenchmark(params.NumBenchmarkPasses, dictionary);
		}
		else if (params.Command == CommandLine.kEncode || params.Command == CommandLine.kDecode)
		{
			...
			{
				com.im.common.util.lzma.SevenZip.Compression.LZMA.Encoder encoder = new com.im.common.util.lzma.SevenZip.Compression.LZMA.Encoder();
			...
			else
			{
				...
				com.im.common.util.lzma.SevenZip.Compression.LZMA.Decoder decoder = new com.im.common.util.lzma.SevenZip.Compression.LZMA.Decoder();
