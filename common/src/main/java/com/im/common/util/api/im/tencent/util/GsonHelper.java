// package com.im.common.util.api.im.tencent.util;
//
...
//    * @return JsonObject对象.
//    */
//   public static JsonObject buildJsonObject(Object... keyOrValue) throws TencentImErrorException {
...
//    * @param keyOrValue 包含key或value的数组
//    */
//   public static void put(JsonObject jsonObject, Object... keyOrValue) throws TencentImErrorException {
//     if (keyOrValue.length % 2 == 1) {
//       throw new TencentImErrorException("参数个数必须为偶数");
//     }
//
...
//       } else {
//         jsonObject.add(key.toString(), TiGsonBuilder.create().toJsonTree(value));
//       }
//     }
//
//   }
