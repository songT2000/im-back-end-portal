...
public class SysNoticeAddParam {
    @NotBlank
    @ApiModelProperty(value = "公告标题", required = true, position = 1)
    private String title;

    @NotBlank
    @ApiModelProperty(value = "公告简介", required = true, position = 2)
    private String simpleContent;

    @NotBlank
    @ApiModelProperty(value = "公告内容", required = true, position = 3)
    ...
    @NotNull
    @ApiModelProperty(value = "是否显示", required = true, position = 5)
    private Boolean showing;

    @NotNull
    @ApiModelProperty(value = "是否置顶", required = true, position = 6)
    private Boolean top;
