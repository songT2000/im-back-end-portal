...
public class AdminExceptionHandler {
    ...
    public Object handleNoHandlerFoundException(HttpServletRequest request) {
        LOG.debug("无此接口：{}", RequestUtil.getRequestPath(request));
        return RestResponse.exception(ResponseCode.SYS_NO_SUCH_METHOD);
    }
    ...
    public Object handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
        return RestResponse.exception(ResponseCode.SYS_REQUEST_PARAM_ERROR, e.getParameterName());
    }
    ...
    public Object handleBindException(BindException e) {
        ...
        if (fieldError != null) {
            ...
            if (BIND_EXCEPTION_CODE_TYPE_MISMATCH.equals(code)) {
                String errorMsg = StrUtil.format(BIND_EXCEPTION_CODE_TYPE_MISMATCH_ERROR_MSG, fieldError.getField());
