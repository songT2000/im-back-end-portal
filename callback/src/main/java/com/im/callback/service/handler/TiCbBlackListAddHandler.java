...
@Slf4j
@Component
public class TiCbBlackListAddHandler implements TiCallbackHandler<TiCbPairListRequest> {
    ...
    public TiBaseResult handle(TiCbPairListRequest request, Map<String, Object> context) {
        log.info("接收到一个添加黑名单事件:[{}]", request.toString());
